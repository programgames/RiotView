...
namespace RiotView.app
{
    public sealed class SingletonUtilisateur
    {
        ...
        SingletonUtilisateur()
        {
            ...
            listeUtilisateur["SuppHerHard"].Administrateur = false;
            listeUtilisateur = gestion.AjouterUtilisateur(listeUtilisateur, "root", true, "19/06/2017", "root");
            
            listeUtilisateur["root"].Administrateur = true;
